...
<div class="col-md-10">
<a href="mailto:sahil20-cs@sanskar.org" style="color:#000000">sahilkhanji836@gmail.com</a><br /><br />
...
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers">Developer Contact </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Developer Contact </span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/sahil.jpg" width=100 height=100 alt="Sahil khan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sahil Khan</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">9012001680</h4>
		<h4 style="font-family:'typo' ">sahilkhanji836@gmail.com</h4>
		<h4 style="font-family:'typo' ">Pilkhuwa hapur Uttar Pradesh India, 245304</h4></div></div>
		</p>
      </div>
